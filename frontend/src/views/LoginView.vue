...
<template>
    <div
        class="max-w-[400px] bg-[#fdfdfd] mx-auto mt-[200px] flex flex-col gap-[70px] items-center px-[40px] py-[50px] border-[1px] border-black">
        ...
        <div class="w-full flex flex-col gap-[30px] items-center">
            ...
            <button  class="max-w-[120px]  border-[1px] border-black text-[17px] px-[15px] py-[5px] hover:bg-black hover:text-white"  @click="registerAcc">Login</button>
        </div>
    </div>
</template>