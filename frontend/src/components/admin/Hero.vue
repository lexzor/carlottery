...
<template>
  ...
  <div class="mx-auto container mt-[-220px] flex justify-between items-center">
    ...
    <button v-if="this.$route.params.section == 'evenimente' && this.$route.params.name !== 'editevent'"  data-modal-target="createEventModal" data-modal-toggle="createEventModal" class="bg-[#fff] text-black rounded-full px-4 py-3 flex gap-2 items-center">
