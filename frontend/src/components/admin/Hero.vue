...
<template>
  <div class="bg-[#000]">
    <div class="mx-auto container px-0 pb-[213px]">
      <div class="flex justify-between items-center py-[44px] border-b border-[#FFFFFF1A] px-3">
        ...
        <button @click="account.logOut()" class="bg-white text-black px-[42px] py-[11px] rounded-[30px]">
          Delogare
        </button>
      </div>
    </div>
  ...
  <div class="mx-auto container px-0 mt-[-220px]">
    <div class="px-3 flex justify-between items-center">
      ...
      <button v-if="this.$route.params.section == 'evenimente' && this.$route.name !== 'editevent'"
        data-modal-target="createEventModal" data-modal-toggle="createEventModal"
        class="bg-[#fff] text-black rounded-full px-4 py-3 flex gap-2 items-center">
        <svg class="xl:block hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
