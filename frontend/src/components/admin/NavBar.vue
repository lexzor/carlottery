        ...
        <div class="mx-auto container px-0">
            <div class="flex justify-between items-center py-4 px-3">
                ...
                <div @click="menu = !menu" class="block xl:hidden cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" style="fill: rgb(255,255,255);transform: ;msFilter:;"><path d="M4 6h16v2H4zm4 5h12v2H8zm5 5h7v2h-7z"></path></svg>
                </div>
                <Transition name="slide-fade">
                    <div v-if="menu"
                        ...
                        <router-link to="/adminpanel/evenimente" class="hover:text-white" active-class="activePage">Evenimente</router-link>
                        <router-link to="/adminpanel/utilizatori" class="hover:text-white" active-class="activePage">Utilizatori</router-link>
                        <router-link to="/adminpanel/castigatori" class="hover:text-white" active-class="activePage">Câștigători</router-link>
                        <router-link to="/adminpanel/comenzi" class="hover:text-white" active-class="activePage">Comenzi</router-link>
                        <button
